...
// This file is named `devtools.ts` instead of `logger.ts` because this file's
// name is written to the console in Chrome - just after each message - so it
// might as well be a name that's specific to the tool itself.
