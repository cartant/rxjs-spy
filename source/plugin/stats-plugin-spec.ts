...
describe("StatsPlugin", () => {
    ...
    beforeEach(() => {
        ...
        spy.plug(new GraphPlugin({ keptDuration: -1, spy }), statsPlugin);
    });
    ...
    it("should count inner subscribes", () => {
        ...
        expect(stats.subscribes).to.equal(0);
        expect(stats.rootSubscribes).to.equal(0);
        expect(stats.innerSubscribes).to.equal(0);
        expect(stats.unsubscribes).to.equal(0);
        ...
        expect(stats.rootSubscribes).to.equal(1);
        expect(stats.innerSubscribes).to.equal(1);
        expect(stats.unsubscribes).to.equal(0);
